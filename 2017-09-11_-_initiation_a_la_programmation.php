...
<!--
    ...
    * Date: 2018-11-08
    * Time: 18:12 (UTC+1 : Central European Standard Time)
    * Subject : recompilation de multiple ficher en un seul avec ajouté de coloration syntaxique et de <pre><code> dans la page elle‑même, pour meilleurs lisibilité.
-->
...
<head>
  ...
  <meta name="hour" content="18:12" scheme="HH:mm">
  <meta name="generator" content="PhpStorm 2018.??.??">
...
<header><h1 id="title-h1-2017-09-11-programmation-initiation">2017-09-11 - Initiation à la programmation :</h1></header>
...
<main id="main" class="ui container">
  ...
  <article id="article">
	...
	<section id="#section-table-of-contents">
		...
		<fieldset>
		  <legend><h2 id="title-h2-table-of-contents"><a href="?#title-h2-table-of-contents">Table de's matière's :</a></h2></legend>
	...
	<section id="section-principal">
	  ...
	  <section>
		<fieldset>
		  <legend><h2 id="title-h2-ide-frameworks"><a href="?#title-h2-table-of-contents">I.D.E. & FrameVorg's :</a></h2></legend>
		  <ul>
			<li>PhpStorm</li>
			<li>Symfôny</li>
			<li>Larawêl</li>
		  ...
		  <h3 id="title-h3-programmation-innitiation-parameters-to-set-in-setting"><a href="?#title-h2-table-of-contents">Paramètre à régler dans les Setting's selon le professeur Patrick Marthus :</a></h3>
		  <ul>
	  ...
	  <section>
		<fieldset>
		  <legend><h2 id="title-h2-01-output"><a href="?#title-h2-table-of-contents">Out‑put :</a></h2></legend>
...
echo ('Hello World'); // Pas de parenthèses car ECHO n'est pas une FONCTION, c'est une structure du langage,
					  // PHP est composé de structure de langage (IF, FOR) & de fonctions et de mots clés.
					  // Les parenthèses ont les indique pour les fonctions. PHP est permissif,
					  // il vous donne la possibilité d'écrire de plusieurs façon différentes.</code></pre><?php
				...
				?>
			  <pre><code class="language-php line-numbers">gettype($version); // gettype est une fonction.
...
&lt;h3&gt;Hello&lt;/h3&gt;?&gt;</code></pre>
	  ...
	  <section>
		<fieldset>
		  <legend><h2 id="title-h2-02-ssi"><a href="?#title-h2-table-of-contents">S.S.I. (Server Side Include) :</a>
			</h2></legend>
			<?php
			/**
			 * Created by PhpStorm.
...
*/?&gt;</code></pre>
	  ...
	  <section>
		<fieldset>
		  <legend><h3 id="title-h3-03-intro-variables"><a href="?#title-h2-table-of-contents">Intro‑variable's :</a>
			</h3></legend>
		  <pre><code class="language-php line-numbers">&lt;?php
/**
 * Created by PhpStorm.
...
*/
  ...
  echo '&lt;p&gt;nom correctement écrit&lt;/p&gt;';</code></pre>
		  ...
		  if (!isset($admin)) { echo '<p>La variable n\'existe pas {!isset(...)}</p>'; }
...
<footer id="footer">
  ...
  <!-- W3School -->
  <script src="../../../assets/js/w3schools/sort_table.js"></script>
