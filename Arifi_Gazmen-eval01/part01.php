...
$version = 6;
echo '<br>';
echo $createur.' est l\'inventeur de '.$langage.' qui actuellement est dans sa version '.(++$version).'.';
...
if($a < $b && $b < $c && $a < $c) // Correction : if($a < $b && $b < $c)
{
...
if(is_integer($val)) // Correction : if(is_int($val))
{
    echo 'Est un entier';
}
else
