...
<?= $createdUserDateTimeUpdateSubjectComment ?>
...
<head>
    ...
    <meta name="date" content="<?= $contentDate ?>" scheme="YYYY-MM-DD">
    <meta name="hour" content="<?= $contentHour ?>" scheme="HH:mm">
    <meta name="generator" content="<?= $contentGenerator ?>">
    ...
    <style>
		...
		body, p, code, kbd, samp, code[class*="language-"], pre[class*="language-"], .ui.segment, .ui.segments .segment {
			font-size: 18px;
		}
    </style>
